<?php
	...
	echo "
	<div class='home_cetak'>
		<h2>Laporan</2>
		<form method='post' action='?module=lap_cetak_struk'>
			<table class='list'>
	        	<tr><td colspan=2><strong><b>Laporan Pemesanan Per Periode</b></strong></td></tr>
	 				  	...
	 				  	while($r=mysqli_fetch_array($sql)){
	 				  		...
	 				  		echo"<tbody>
	 				  				<tr>
	 				  					...
	 				  					<td class='left'><a href='modul/mod_cetak_struk/cetak_lap_pemesanan_perinvoice.php?no_nota=$r[no_transaksi]' target='_blank'><img src='images/btn_view.png' width='20' height='20' border='0'></a></td>
	 				  				</tr>
	 				  			</tbody>";
	 				  		$no++;
	 				  	}
